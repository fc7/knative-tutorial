...
Camel K is installed using its https://operatorhub.io/operator/camel-k[operator].


Run the following command to install the operator and setup `Camel K` in the namespace:
