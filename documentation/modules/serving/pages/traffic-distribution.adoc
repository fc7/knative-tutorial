...
// REMOVE THIS ONCE THE IMAGE IS FIXED
[IMPORTANT,subs="attributes+,+macros"]
====

The image `quay.io/rhdevelopers/blue-green-canary` will probably not work on a recent version of OpenShift.
Please use `quay.io/rh_ee_fcharett/blue-green-canary` instead. 
It was created with https://github.com/fc7/knative-tutorial/blob/master/apps/blue-green-canary/Dockerfile[this Dockerfile].
====
